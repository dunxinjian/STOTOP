...
public static class TestDbContextFactory
{
    ...
    {
        STOTOPDbContext.RegisterModuleAssembly(typeof(TmTask).Assembly);
        STOTOPDbContext.RegisterModuleAssembly(typeof(SysUser).Assembly); // 任务可见性/负责人/项目成员查询跨 System 用户与组织
